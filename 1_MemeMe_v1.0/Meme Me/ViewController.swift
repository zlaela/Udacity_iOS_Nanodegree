...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private func clearSubscriptions() {
        /**
         Sure, I could specifically unsubscribe from keyboard notifications specifically,
    ...
    private func save(){
        ...
        _ = Meme(topText: self.topText.text ?? "TOP TEXT",
                 bottomText: self.bottomText.text ?? "BOTTOM TEXT",
                 image: self.imageView.image!,
                 memedImage: memedImage!)
        
        // TOOD: save the Meme image to image library
    }
